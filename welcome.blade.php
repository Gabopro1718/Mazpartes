...
<html lang="es">
    ...
    <body>
        ...
        <!-- shop locator (popup) -->
        <!-- //header-bottom -->
    <marquee>AVISOS IMPORTANTES PARA LOS CLIENTES</marquee>
            ...
            <div class="agileinfo-ads-display col-lg-9">
                <div class="wrapper">
                    ...
                    <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                        <h3 class="heading-tittle text-center font-italic">MARCAS</h3>
                        <div class="row">
                            @INCLUDE('single')
                    ...
                    <!-- second section -->
                    <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                        <h3 class="heading-tittle text-center font-italic">CATEGORIAS</h3>
                        <div class="row">
                            <div class="col-md-4 product-men mt-5">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item text-center">
                    ...
                    <div class="px-sm-5 px-3">
                        <div class="row">
                            <img src="images/image1.png" width="760px" alt="">
                        </div>
                    </div>
                    <!-- //third section -->
                    <!-- fourth section -->
                    <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
                        <h3 class="heading-tittle text-center font-italic">FABRICANTE</h3>
                        <div class="row">
                            <div class="col-md-4 product-men mt-5">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item text-center">
